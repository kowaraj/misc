...
;;       (border-panel
;;         :border 5
;;         :east (listbox :model (-> 'seesaw.core ns-publics keys sort))
;;         :north (toolbar
;;                  :floatable? false
;;                  :items [(toggle :id :pencil  :class :tool :text "Pencil" )
;;                          (toggle :id :line    :class :tool :text "Line")
;;                          (toggle :id :rect    :class :tool :text "Rect":selected? true)
